...
public interface ProxyUserInfoService extends MongoService<ProxyUserInfo> {
     ...
     * @param resources
     */
    void addUser(String proxyId, String pin, String phone, String pass, String desc, Long[] resources);
     ...
     * @param status
     */
    void upUser(String proxyId, String pin, String phone, String desc, boolean status, Long[] resources);
    /**
     * 删除用户
     * @param proxyId
     * @param id
     */
    void delById(String proxyId, String id);
    void changePass(String id, String password, String vpassword);
}
