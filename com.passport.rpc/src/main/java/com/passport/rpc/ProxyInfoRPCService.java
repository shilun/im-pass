...
public interface ProxyInfoRPCService {
     ...
     * @return
     */
    RPCResult<Boolean> addUser(String proxyId, String pin, String phone, String pass, String desc, Long resources[]);
     ...
     * @return
     */
    RPCResult<Boolean> upUser(String proxyId, String pin, String phone, String desc, boolean status, Long[] resources);
